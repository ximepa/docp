...
urlpatterns = patterns('claim.views',
                       ...
                       url(r'^statistics_current/$', 'current_claims_internet_statistic_ajax', name='current_claims_internet_statistic_ajax'),
                       url(r'^statistics_current_view/$', 'current_internet_claims_statistic_view', name='current_internet_claims_statistic_view'),
