...
urlpatterns = patterns('claim.views',
                       ...
                       url(r'^claims_statistic_year/$', 'claims_statistic_year', name='claims_statistic_year'),
                       url(r'^claims_statistic_month/$', 'claims_statistic_month', name='claims_statistic_month'),
                       url(r'^claims_statistic_day/$', 'claims_statistic_day', name='claims_statistic_day'),
