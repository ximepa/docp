...
urlpatterns = patterns('claim.views',
                       ...
                       url(r'^worker_1_statistic/year/$', 'worker_1_internet_statistic_year', name='worker_1_internet_statistic_year'),
                       url(r'^worker_1_statistic/month/$', 'worker_1_internet_statistic_month', name='worker_1_internet_statistic_month'),
